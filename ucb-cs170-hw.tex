...
\begin{tikzpicture} 
        \begin{scope},[fill opacity=0.05]
        \fill[yellow] \circleun;
        \fill[yellow] \circledeux;
     \end{scope};
     \draw \rectangleun node[below] {$H$};
     \draw \circleun node[below] {$B$};
     \draw \circledeux node[below] {$A$};
\end{tikzpicture}
...
\begin{tikzpicture}
   \draw\rectangleunun node[below] {$I$};
   \draw \circleunun node[below] {$A$};
   \draw \circledeuxdeux node[below] {$B$};
   \begin{scope} [fill opacity=0.5]
       \clip \circleunun;
       \fill[green] \circledeuxdeux;
    \end{scope}
\end{tikzpicture}
